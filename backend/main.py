...
from routes import csv_movies, contact, admin_actions, admin_api
import os
...
async def lifespan(app: FastAPI):
    ...
    # Recommender loads lazily on first request
    yield
...
def admin_dashboard(key: str = Query(default="")):
    ...
    return HTMLResponse(DASHBOARD_HTML, headers={"Content-Type": "text/html; charset=utf-8"})
